...
def get_plate_options() -> list[str]:
    df = read_df(
        """
...
def page_history() -> None:
    ...
    plate_options = ["Tümü"] + get_plate_options()
    ...
    with st.expander("Filtreler", expanded=True):
        ...
        plate_filter = c9.text_input("Plaka içinde ara", placeholder="Örn: 34 veya APR")
        c10.caption("Plaka filtresi, vardiya girişinde tanımlanan araç plakalarından otomatik oluşur. Net plaka için dropdown; parça arama için metin kutusunu kullanabilirsin.")
